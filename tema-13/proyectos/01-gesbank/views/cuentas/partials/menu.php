            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link <?= (!in_array($_SESSION['id_rol'], $GLOBALS['cuenta']['export'])) ? 'disabled' : '' ?>"
                        ...
                        onclick="return confirm('Se va a realizar la exportación de la tabla. ¿Continuar?')">
                        Exportar</a>
                </li>
                <li class="nav-item">
                    <button type="button"
                ...
                <li class="nav-item">
                            <a class="nav-link <?= (in_array($_SESSION['id_rol'], $GLOBALS['cuenta']['pdf']) || in_array($_SESSION['id_rol'], $GLOBALS['cuenta']['pdf'])) ? 'active' : 'disabled' ?>" aria-current="page" href="<?= URL ?>cuentas/pdf">PDF</a>
                </li>
            </ul>
